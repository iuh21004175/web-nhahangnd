document.addEventListener("DOMContentLoaded", function () {
    xuLyMonAn();
    document.getElementById('categories-tab').addEventListener('click', async function () {
        await xuLyDanhMuc();
    })
    document.getElementById('menu-items-tab').addEventListener('click', async function () {
        await xuLyMonAn();
    })
});
...
async function xuLyMonAn(){
    ...
    async function thaoTacVoiBang(list){
        const tbody = document.querySelector('#menu-items .table-danhSach tbody');
